...
---@type fun(posX: number, posY: number, width: number, height: number, u: number, v: number, usize: number, vsize: number, image: image, numberrotation, rotationCenterOffsetX?: number, rotationCenterOffsetY?: number, color?: integer, postGUI?: boolean): boolean
...
---@type fun(integersurfaceIndex, texture?: element, pixels?: string, x?: integer, y?: integer, width?: integer, height?: integer): boolean
...
---@type fun(theShader: element, rotationX: number, rotationY: number, rotationZ: number, numberrotationCenterOffsetX, rotationCenterOffsetY?: number, rotationCenterOffsetZ?: number, bRotationCenterOffsetOriginIsScreen?: boolean, perspectiveCenterOffsetX?: number, perspectiveCenterOffsetY?: number, bPerspectiveCenterOffsetOriginIsScreen?: boolean): boolean
...
---@type fun(pixels: string, newFormat?: string, quality?: integer): string
...
---@type fun(pType: string, postGUI: boolean, vertice1?: table, vertice2?: table, ...?: table): boolean
function dxDrawPrimitive () end

---@type fun(primitiveType: string, material: mixMaterial, postGUI: boolean, vertex1: table, vertex2: table, vertex3?: table, vertex4?: table, ...): boolean
