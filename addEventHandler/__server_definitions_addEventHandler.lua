...
---@alias addEventHandler_onElementDataChange fun(eventName: "onElementDataChange", attachedTo: element, handlerFunction: fun(theKey: string, oldValue: unknown, newValue: unknown), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onPlayerProjectileCreation fun(eventName: "onPlayerProjectileCreation", attachedTo: element, handlerFunction: fun(weaponType: projectileId, x: number, y: number, z: number, force: number | nil, target: element | false, rotX: number, rotY: number, rotZ: number, velX: number, velY: number, velZ: number), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onPlayerTeamChange fun(eventName: "onPlayerTeamChange", attachedTo: element, handlerFunction: fun(oldTeam: team, newTeam: team), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onVehicleExplode fun(eventName: "onVehicleExplode", attachedTo: element, handlerFunction: fun(), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
