...
---@alias addEventHandler_onPlayerTriggerEventThreshold fun(eventName: "onPlayerTriggerEventThreshold", attachedTo: element, handlerFunction: fun(eventName: string), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onPlayerWasted fun(eventName: "onPlayerWasted", attachedTo: element, handlerFunction: fun(totalAmmo: integer, killer: element | false, killerWeapon: weaponId | damageTypeId | integer, bodypart: bodyPartId, stealth: boolean, animGroup: integer, animId: integer), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onPlayerChangesProtectedData fun(eventName: "onPlayerChangesProtectedData", attachedTo: element, handlerFunction: fun(element: element, key: string, value: unknownSyncAble), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
---@alias addEventHandler_onPlayerChangesWorldSpecialProperty fun(eventName: "onPlayerChangesWorldSpecialProperty", attachedTo: element, handlerFunction: fun(propname: worldSpecialProperty, enable: boolean), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
---@alias addEventHandler_onPlayerTeleport fun(eventName: "onPlayerTeleport", attachedTo: element, handlerFunction: fun(previousX: number, previousY: number, previousZ: number, currentX: number, currentY: number, currentZ: number), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
---@alias addEventHandler_onPlayerWeaponReload fun(eventName: "onPlayerWeaponReload", attachedTo: element, handlerFunction: fun(weapon: weaponId, ammoInClip: integer, ammo: integer), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onPedWasted fun(eventName: "onPedWasted", attachedTo: element, handlerFunction: fun(totalAmmo: integer, killer: element | false, killerWeapon: weaponId | damageTypeId | integer, bodypart: bodyPartId, stealth: boolean, animGroup: integer, animId: integer), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onShutdown fun(eventName: "onShutdown", attachedTo: element, handlerFunction: fun(theResource: resource | nil, reason: string), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
