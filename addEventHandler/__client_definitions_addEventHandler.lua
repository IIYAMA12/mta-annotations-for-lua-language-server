...
---@alias addEventHandler_onClientElementDataChange fun(eventName: "onClientElementDataChange", attachedTo: element, handlerFunction: fun(theKey: string, oldValue: unknown, newValue: unknown), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
