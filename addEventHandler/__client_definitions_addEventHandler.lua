...
---@alias addEventHandler_onClientBrowserConsoleMessage fun(eventName: "onClientBrowserConsoleMessage", attachedTo: element, handlerFunction: fun(message: string, source: string, line: integer, level: integer), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onClientGUIClick fun(eventName: "onClientGUIClick", attachedTo: element, handlerFunction: fun(button: mouseButton, state: "up", absoluteX: integer, absoluteY: integer), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onClientPedChoke fun(eventName: "onClientPedChoke", attachedTo: element, handlerFunction: fun(), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onClientPlayerTask fun(eventName: "onClientPlayerTask", attachedTo: element, handlerFunction: fun(priority: integer, slot: integer, name: string), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
...
---@alias addEventHandler_onClientPlayerWasted fun(eventName: "onClientPlayerWasted", attachedTo: element, handlerFunction: fun(killer: element | nil, weapon: weaponId | damageTypeId | integer, bodypart: bodyPartId, stealth: boolean, animGroup: integer, animId: integer), getPropagated?: boolean, priority?: addEventHandlerPriority): boolean
