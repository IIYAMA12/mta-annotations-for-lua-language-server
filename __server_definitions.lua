...
---@type fun(theElement: ped | vehicle, thePlayer: player | boolean, persist?: boolean): boolean Returns true if the syncer was changed successfully, false if the element passed was not a ped or vehicle.
...
---@type fun(thePed: ped): boolean Returns true if the pedestrian was made to reload, or false if invalid arguments were passed or that pedestrian has a weapon which cannot be reloaded.
...
See [Server mtaserver.conf](https://wiki.multitheftauto.com/wiki/Server_mtaserver.conf) for config settings.
]]
...
--[[
[Wiki](https://wiki.multitheftauto.com/wiki/SetAccountSerial)
]]
